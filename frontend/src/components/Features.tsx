...
const features = [
  ...
  },
  {
    ...
    description: 'Study anytime, anywhere with self-paced access across all your devices.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Learn through real-world tasks that sharpen your skills and build confidence for real work.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
